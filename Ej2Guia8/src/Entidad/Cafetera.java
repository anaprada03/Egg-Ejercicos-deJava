...
public class Cafetera {
    ...
    public int capciadAct;

    public Cafetera() {
        capacidadMax = 1000;
    }

    public Cafetera(int capacidadMax, int capciadAct) {
        this.capacidadMax = capacidadMax;
        this.capciadAct = capciadAct;
    }
    ...
    public int getCapciadAct() {
        return capciadAct;
    }

    public void setCapciadAct(int capciadAct) {
        this.capciadAct = capciadAct;
    }
